<x-guest-layout>
    {{-- Breadcrumb --}}
    <div class="shadow-md border-2 border-gray-300 py-2 bg-white mt-24">
            ...
            <div class="flex justify-between">
                ...
                <div class="w-3/12">
                    <ul class="flex justify-end -mr-2">
                        <li>
                            <a class="flex flex-col justify-center items-center mx-2 border-2 border-gray-200 p-3 hover:border-red-400 duration-200" href="#">
            ...
            <div class="w-9/12">
                <div id="slider" class="">
                    <div class="gallery-slider">
                        <div style="background-image: url(/img/hero-bg.jpg);" class="gallery-slider-item bg-cover bg-center"></div>
                        <div style="background-image: url(/img/hero-bg.jpg);" class="gallery-slider-item bg-cover bg-center"></div>
                        <div style="background-image: url(/img/hero-bg.jpg);" class="gallery-slider-item bg-cover bg-center"></div>
                        <div style="background-image: url(/img/hero-bg.jpg);" class="gallery-slider-item bg-cover bg-center"></div>
                        <div style="background-image: url(/img/hero-bg.jpg);" class="gallery-slider-item bg-cover bg-center"></div>
                    ...
                    <div class="thumbnail-slider">
                        <div style="background-image: url(/img/hero-bg.jpg);" class="thumbnail-slider-item bg-cover bg-center"></div>
                        <div style="background-image: url(/img/hero-bg.jpg);" class="thumbnail-slider-item bg-cover bg-center"></div>
                        <div style="background-image: url(/img/hero-bg.jpg);" class="thumbnail-slider-item bg-cover bg-center"></div>
                        <div style="background-image: url(/img/hero-bg.jpg);" class="thumbnail-slider-item bg-cover bg-center"></div>
                        <div style="background-image: url(/img/hero-bg.jpg);" class="thumbnail-slider-item bg-cover bg-center"></div>
                ...
                <div class="flex justify-between items-center bg-white p-8 mt-10 shadow-sm">
                    ...
                    <div class="ml-2 w-10/12 text-base flex justify-between">
                        <div class="flex-1 border-l-2 border-gray-300 ml-3 pl-3 self-center">
                            <ul>
                                <li class="flex text-sm mb-2">
                                    <div class="flex"><i class="fa fa-home mr-2 text-red-400 w-5 text-center"></i><span class="text-sm">Type:</span></div>
                                    <span class="ml-2 font-bold">Penthouse</span>
                                </li>
                                <li class="flex text-sm">
                                    <div class="flex"><i class="fa fa-bed mr-2 text-red-400 w-5 text-center"></i><span class="text-sm">Bedrooms:</span></div>
                        ...
                        <div class="flex-1 border-l-2 border-gray-300 ml-3 pl-3 self-center">
                            <ul>
                                <li class="flex text-sm mb-2">
                                    <div class="flex"><i class="fa fa-shower mr-2 text-red-400 w-5 text-center"></i><span class="text-sm">Bathrooms:</span></div>
                                    <span class="ml-2 font-bold">4</span>
                                </li>
                                <li class="flex text-sm">
                                    <div class="flex"><i class="fa fa-map-marker mr-2 text-red-400 w-5 text-center"></i><span class="text-sm">Location:</span></div>
                        ...
                        <div class="flex-1 border-l-2 border-gray-300 ml-3 pl-3 self-center">
                            <ul>
                                <li class="flex text-sm mb-2">
                                    <div class="flex"><i class="fa fa-gratipay mr-2 text-red-400 w-5 text-center"></i><span class="text-sm">Living space sqm:</span></div>
                                    <span class="ml-2 font-bold">327</span>
                                </li>
                                <li class="flex text-sm">
                                    <div class="flex"><i class="fa fa-low-vision mr-2 text-red-400 w-5 text-center"></i><span class="text-sm">Pool</span></div>
